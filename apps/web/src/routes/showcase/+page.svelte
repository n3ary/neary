...
<script lang="ts">
  ...
  const demoVehicles: Vehicle[] = [
    ...
    { kind: 'reconciled', id: 'v-reconciled-1', route: route35,
      ...
      confidence: 'medium',
      liveSources: ['gtfs-rt'] },
    { kind: 'corroborated', id: 'v-corroborated-1', route: route24,
    ...
    { kind: 'predicted', id: 'v-predicted-1', route: route9,
    ...
    { kind: 'scheduled', id: 'v-sched-1', route: routeM,
