...
- `feed-agnostic.md` — the "no per-feed exceptions in app code" rule is specific to the neary PWA's contract with feed data. The producer repos (`gtfs`, `cluj-napoca-gtfs-adapter`) are upstream of neary's data and don't apply.
